...
namespace AppleAuthSample
{
    ...
    LoginMenu.SignInWithAppleButton.gameObject.SetActive(true);
#else
            LoginMenu.SignInWithAppleButton.gameObject.SetActive(false);
#endif
        ...
        public string _appleUserID;
        public string _appleEmail;
        public string _appleName;
        private void SetupGameMenu(string appleUserId, ICredential credential)
        {
            ...
            Debug.Log("debug appleid with credential" + appleUserId);
            ...
            try
            {
                _name = appleIdCredential.FullName.Nickname;
            ...
            Debug.Log("Sign in API call apple user" + appleUserId + " name:" + _name + "email:" + email);

            Debug.Log("SocialLogin API Call Apple");

            APIManager.Instance.SocialLogin("apple", _appleUserID, email, "", "", SocialLogInResponse);
        }
