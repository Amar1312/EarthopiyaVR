Shader "World Political Map/Unlit Earth Scenic Scatter City Lights" 
{
	...
	SubShader 
	{
		...
		Pass {
			...
			uniform float _CityLightsBrightness;
			...
			Varyings vert(Attributes input)
			{
				...
				output.viewDir = normalize(GetWorldSpaceViewDir(TransformObjectToWorld(input.positionOS.xyz)));
	...
	// Keep existing subshader for built-in pipeline
	SubShader {
