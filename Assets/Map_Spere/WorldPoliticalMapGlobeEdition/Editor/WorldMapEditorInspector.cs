...
namespace WPM {
    ...
    public class WorldMapEditorInspector : Editor {
        ...
        static Vector3 pointSnap = new Vector3(0.1f, 0.1f, 0.1f);
                ...
                case OPERATION_MODE.SELECTION:
                    if (_editor.editingMode == EDITING_MODE.COUNTRIES && _editor.countryIndex < 0) {
                        ...
                        if (_editor.countryIndex < 0) {
                            ...
                            EditorGUILayout.HelpBox("Hold down Control key to select multiple provinces.", MessageType.Info);
                        }
                    }
                    break;
        ...
        void ShowEntitySelectors () {
            ...
            if (_editor.editingMode == EDITING_MODE.PROVINCES && _editor.countryIndex >= 0) {
                ...
                int selectedProvincesCount = _editor.selectedProvinces.Count;
        ...
        void FocusSpherePoint (Vector3 point) {
            ...
            _map.globeTransform.localRotation = Quaternion.AngleAxis(angle, axis);
            // straighten view
