    ...
    _map.labelsAntialias
            ...
            if (expandCountriesSection) {
                ...
                if (_map.enableCountryHighlight) {
                    ...
                    _map.showOutline = EditorGUILayout.Toggle("Show Outline", _map.showOutline);
                    if (_map.showOutline) {
                        EditorGUI.indentLevel++;
            ...
            if (expandProvincesSection) {
                ...
                if (_map.showProvinces) {
                    ...
                    if (_map.enableProvinceHighlight) {
                        ...
                        _map.showProvinceOutline = EditorGUILayout.Toggle("Show Province Outline", _map.showProvinceOutline);
                        if (_map.showProvinceOutline) {
                            EditorGUI.indentLevel++;
                            _map.provinceOutlineColor = WPMEditorStyles.HDRColorPicker("Outline Color", _map.provinceOutlineColor);
                            EditorGUI.indentLevel--;
                        }
