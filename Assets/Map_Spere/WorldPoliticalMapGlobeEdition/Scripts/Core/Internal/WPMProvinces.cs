    ...
    public partial class WorldMapGlobe : MonoBehaviour {
        ...
        public void RefreshProvinceGeometry (int provinceIndex) {
            ...
            for (int r = 0; r < regionCount; r++) {
                ...
                provinceRegion.surfaceGameObjectIsDirty = true;
            }
        ...
        void UpdateProvincesMat () {
            if (provincesMatCurrent == null)
                return;
            // Different alpha?
            if (_provincesColor.a != provincesMatCurrent.color.a && (_provincesColor.a >= 1f && provincesMatCurrent.color.a < 1f || _provincesColor.a < 1f && provincesMatCurrent.color.a >= 1f)) {
        ...
        bool GetProvinceUnderMouse (int countryIndex, Vector3 spherePoint, out int provinceIndex, out int regionIndex) {
            ...
            for (int tries = 0; tries < 75; tries++) {
                ...
                for (int p = 0; p < provincesCount; p++) {
                    ...
                    for (int pr = 0; pr < provinceRegionsCount; pr++) {
        ...
        public void HighlightProvinceRegion (int provinceIndex, int regionIndex, bool refreshGeometry) {
            ...
            if (doHighlight) {
                ...
                // Draw outline if showProvinceOutline is enabled
                if (_showProvinceOutline && provinceRegionHighlightedObj != null) {
                    Region region = _provinces[provinceIndex].regions[regionIndex];
                    ToggleRegionOutline(region, true, _provinceOutlineColor);
                }
            }
        ...
        void HideProvinceRegionHighlight () {
            ...
            if (_provinceRegionHighlighted != null && provinceRegionHighlightedObj != null) {
                // Remove outline when hiding province highlight
                if (_showProvinceOutline && !_provinceRegionHighlighted.customOutline) {
                    ToggleRegionOutline(_provinceRegionHighlighted, false);
                }
