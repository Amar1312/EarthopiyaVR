...
namespace WPM {
    ...
    public partial class WorldMapGlobe : MonoBehaviour {
        ...
        float previousCamDistanceToTargetPosition;
        ...
        void OrbitStart () {
            ...
            previousCamDistanceToTargetPosition = Vector3.Distance(pivotTransform.position, targetPosition);
        }
        ...
        void RotateCameraAroundAxis (float angle) {
            ...
            if (_navigationMode == NAVIGATION_MODE.EARTH_ROTATES) {
                globeTransform.Rotate(axis, angle, Space.World);
            } else {
        ...
        void Rotate (Camera cam, float t) {
            if (_navigationMode == NAVIGATION_MODE.EARTH_ROTATES) {
                globeTransform.Rotate(cam.transform.up, dragDirection.x * t, Space.World);
        ...
        void CheckLatitudeConstraint () {
            ...
            if (_navigationMode == NAVIGATION_MODE.CAMERA_ROTATES) {
                ...
                Vector3 axis = Vector3.Cross(transform.up, _pivotTransform.forward);
                globeTransform.Rotate(axis, -corr, Space.World);
            }
            dragDampingStart = 0;
        }
        ...
        void PerformOrbit (Camera cam) {
            ...
            if (_enableOrbit) {
                ...
                if (_pitchAdjustByDistance) {
                    ...
                    if (pitch > maxPitchByDistance || (_orbitTiltOnZoomIn && camDistanceToTargetPosition < previousCamDistanceToTargetPosition)) {
            ...
            previousCamDistanceToTargetPosition = camDistanceToTargetPosition;
        }
        ...
        void NavigateToDestination () {
            ...
            if (flyToMode == NAVIGATION_MODE.EARTH_ROTATES || _earthInvertedMode) {
                ...
                globeTransform.rotation = Quaternion.Lerp(flyToStartQuaternion, flyToEndQuaternion, t);
            } else {
                // Apply new zoom level
                if (flyToCameraDistanceEnabled) {
                    SetCameraDistance(LerpCameraDistance(t));
