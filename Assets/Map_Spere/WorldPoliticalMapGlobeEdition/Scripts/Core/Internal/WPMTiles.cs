        ...
        void InitTileSystem() {
            ...
            if (!Directory.Exists(cachePath)) {
                try {
                    ...
                    Debug.LogWarning("WPM: Unable to create tiles cache directory: " + e.Message);
                }
            }
				...
				if (_tileOfflineTilesSourceType == OFFLINE_TILES_SOURCE_TYPE.Resources) {
					...
					if (File.Exists(path)) {
						...
						if (texData != null) {
							...
							tileTex.LoadImage(texData, true);
						}
					}
				}
        ...
        class BackgroundSaver {
            ...
            void SaveTextureToCache() {
                try {
                    ...
                    Debug.LogWarning("WPM: Failed to write tile cache file '" + filePath + "': " + e.Message);
                }
            }
